...
<div class="container">
    <div class="row">
        <div class="col-md-8 offset-md-2">
            <div class="card">
                <div class="card-header">新增請款單</div>
                <div class="card-body">
                    <div class="container-fluid">
                        <form action="{{ route('paymentrequest.store') }}" method="POST" class="mt-2">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control form-control-sm {{ $errors->has('request_price') ? ' is-invalid' : '' }}" name="request_price" id="request_price">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control form-control-sm {{ $errors->has('request_amount') ? ' is-invalid' : '' }}" name="request_amount" id="request_amount">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control form-control-sm {{ $errors->has('request_total') ? ' is-invalid' : '' }}" name="request_total" id="request_total">
