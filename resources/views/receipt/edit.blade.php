                    ...
                    <div class="container-fluid">
                        <form action="{{ route('receipt.update', ['id' => $data->receipt_id]) }}" method="POST" class="mt-2">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                <input type="date" class="form-control form-control-sm" name="receipt_at" id="receipt_at" value="{{ $receipt_at ?? '' }}">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control form-control-sm {{ $errors->has('receipt_price') ? ' is-invalid' : '' }}" name="receipt_price" id="receipt_price" value="{{ $data->receipt_price ?? '' }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control form-control-sm {{ $errors->has('receipt_amount') ? ' is-invalid' : '' }}" name="receipt_amount" id="receipt_amount" value="{{ $data->receipt_amount ?? '' }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control form-control-sm {{ $errors->has('receipt_total') ? ' is-invalid' : '' }}" name="receipt_total" id="receipt_total" value="{{ $data->receipt_total ?? '' }}">
