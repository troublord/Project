            ...
            <h4>
                @auth
                    <div class="float-right">
                        <a href="{{ route('receipt.create') }}" class="btn btn-sm btn-success ml-2">
                ...
                <div class="card mb-3">
                    <div class="card-body">
                        <div class="container-fluid p-0">
                            <div class="row">
                                <div class="col-md-8">
                                    <h4 class="card-title">發票{{ $data->receipt_id }}</h4>
                                </div>
                                <div class="col-md-4">
                                @auth
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                        ...
                                        <a href="{{ route('receipt.show', ['id' => $data->receipt_id]) }}" class="float-right card-link">
                                            詳細資料
                                        </a>
                                        </span>
                                </div>
