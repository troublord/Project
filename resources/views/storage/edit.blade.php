                    ...
                    <div class="container-fluid">
                        <form action="{{ route('storage.update', ['id' => $data->storage_id]) }}" method="POST" class="mt-2">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                <input type="date" class="form-control form-control-sm" name="storage_at" id="storage_at" value="{{ $storage_at ?? '' }}" required>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control form-control-sm {{ $errors->has('storage_amount') ? ' is-invalid' : '' }}" name="storage_amount" id="storage_amount" value="{{ $data->storage_amount ?? '' }}"required>
